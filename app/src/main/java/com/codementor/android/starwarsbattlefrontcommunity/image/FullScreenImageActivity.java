...
public class FullScreenImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String imageUrl = intent.getStringExtra(Content.FULLSCREEN_IMAGE_EXTRA);
        ...
        //TODO - if this is a local image?
//        MediaStore.Images.Media.getContentUri(imageUrl.getPath());
//        String imageUri = getRealPathFromURI(imageUrl);
//
//        Bitmap bitmap = PictureUtils.decodeBitmapFromFile(imageUrl, this);

//        fullscreenImage.setImageBitmap(bitmap);

        Picasso.with(this).load(imageUrl).into(fullscreenImage);

//        fullscreenImage.setImageURI(Uri.parse(imageUrl));
